...
formula += 'б) Какова вероятность, что перегорят ровно две? \n'
...
formula += 'Вероятность наступления событий, равна вероятности перегорания 2-х лампочек, соответственно m=2. \n'
formula += '\n'

# Вычислим  P
P = poisson(2,0.0004,5000)
formula += 'Вычислим  P:\n'
